        ...
        if liga_id_raw in ligas_permitidas:
            ...
            if status_short in statuses["finished"]:
                ...
                if mask.any():
                    ...
                    nuevo_row = {
                        "League": liga_nombre, "Date": fecha_str,
                        "HomeTeam": h_team, "AwayTeam": a_team,
        ...
        for match in lista_partidos:
            ...
            if liga_id_raw in ligas_permitidas:
                ...
                if status_short in statuses_map["upcoming"]:
                    ...
                    target_dict = proyecciones_mañana if match_date_str == fecha_mañana_str else proyecciones_hoy
